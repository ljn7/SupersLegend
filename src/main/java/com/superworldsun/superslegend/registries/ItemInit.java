...
//            () -> new ElementMedallion(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> SMALL_KEY = ITEMS.register("small_key",
            () -> new SmallKey(new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BOSS_KEY = ITEMS.register("boss_key",
            () -> new BossKey(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> ARROW_BUNDLE = ITEMS.register("arrow_bundle",
            () -> new ArrowBundle(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> TRIFORCE_POWER_SHARD = ITEMS.register("triforce_power_shard",
            () -> new TriforceShard(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> ANCIENT_CORE = ITEMS.register("ancient_core",
            () -> new AncientMaterial(new Item.Properties().stacksTo(1)));
...
//            () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> KOKIRI_TUNIC = ITEMS.register("kokiri_tunic",
            () -> new KokiriArmor(ArmorInit.KOKIRI, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> KOKIRI_LEGGINGS = ITEMS.register("kokiri_leggings",
            () -> new KokiriArmor(ArmorInit.KOKIRI, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> KOKIRI_BOOTS = ITEMS.register("kokiri_boots",
            () -> new KokiriArmor(ArmorInit.KOKIRI, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> ZORA_CAP = ITEMS.register("zora_cap",
            () -> new ZoraArmor(ArmorInit.ZORA, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ZORA_TUNIC = ITEMS.register("zora_tunic",
            () -> new ZoraArmor(ArmorInit.ZORA, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ZORA_LEGGINGS = ITEMS.register("zora_leggings",
            () -> new ZoraArmor(ArmorInit.ZORA, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> IRON_BOOTS = ITEMS.register("iron_boots",
            () -> new IronBootsArmor(ArmorInit.IRON_BOOTS, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> ZORA_FLIPPERS = ITEMS.register("zoras_flippers",
            () -> new ZoraFlippersArmor(ArmorInit.FLIPPERS, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> GORON_CAP = ITEMS.register("goron_cap",
            () -> new GoronArmor(ArmorInit.GORON, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> GORON_TUNIC = ITEMS.register("goron_tunic",
            () -> new GoronArmor(ArmorInit.GORON, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> GORON_LEGGINGS = ITEMS.register("goron_leggings",
            () -> new GoronArmor(ArmorInit.GORON, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> HOVER_BOOTS = ITEMS.register("hover_boots",
            () -> new HoverBootsArmor(ArmorInit.HOVER_BOOTS, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> PURPLE_CAP = ITEMS.register("purple_cap",
            () -> new PurpleArmor(ArmorInit.PURPLE, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> PURPLE_TUNIC = ITEMS.register("purple_tunic",
            () -> new PurpleArmor(ArmorInit.PURPLE, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> PURPLE_LEGGINGS = ITEMS.register("purple_leggings",
            () -> new PurpleArmor(ArmorInit.PURPLE, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> PEGASUS_BOOTS = ITEMS.register("pegasus_boots",
            () -> new PegasusBootsArmor(ArmorInit.PEGASUS_BOOTS, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> HEROS_NEW_TUNIC = ITEMS.register("heros_new_tunic",
            () -> new ArmorItem(ArmorInit.HEROS_NEW, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> HEROS_NEW_LEGGINGS = ITEMS.register("heros_new_leggings",
            () -> new ArmorItem(ArmorInit.HEROS_NEW, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> HEROS_NEW_BOOTS = ITEMS.register("heros_new_boots",
            () -> new ArmorItem(ArmorInit.HEROS_NEW, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    /*public static final RegistryObject<Item> ENGINEERS_HAT = ITEMS.register("engineers_hat",
            () -> new ArmorHerosNew(EquipmentSlotType.HEAD, new Item.Properties().stacksTo(1).tab(SupersLegendMain.APPAREL)));
    public static final RegistryObject<Item> ENGINEERS_SHIRT = ITEMS.register("engineers_shirt",
            () -> new ArmorHerosNew(EquipmentSlotType.CHEST, new Item.Properties().stacksTo(1).tab(SupersLegendMain.APPAREL)));
    public static final RegistryObject<Item> ENGINEERS_PANTS = ITEMS.register("engineers_pants",
            () -> new ArmorHerosNew(EquipmentSlotType.LEGS, new Item.Properties().stacksTo(1).tab(SupersLegendMain.APPAREL)));
    public static final RegistryObject<Item> ENGINEERS_BOOTS = ITEMS.register("engineers_boots",
            () -> new ArmorHerosNew(EquipmentSlotType.FEET, new Item.Properties().stacksTo(1).tab(SupersLegendMain.APPAREL)));*/

    public static final RegistryObject<Item> MAGIC_ARMOR_CAP = ITEMS.register("magic_armor_cap",
            () -> new MagicArmor(ArmorInit.MAGIC, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MAGIC_ARMOR_TUNIC = ITEMS.register("magic_armor_tunic",
            () -> new MagicArmor(ArmorInit.MAGIC, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MAGIC_ARMOR_LEGGINGS = ITEMS.register("magic_armor_leggings",
            () -> new MagicArmor(ArmorInit.MAGIC, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> MAGIC_ARMOR_BOOTS = ITEMS.register("magic_armor_boots",
            () -> new MagicArmor(ArmorInit.MAGIC, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> DARK_CAP = ITEMS.register("dark_cap",
            () -> new DarkArmor(ArmorInit.DARK, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DARK_TUNIC = ITEMS.register("dark_tunic",
            () -> new DarkArmor(ArmorInit.DARK, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DARK_TROUSERS = ITEMS.register("dark_trousers",
            () -> new DarkArmor(ArmorInit.DARK, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DARK_BOOTS = ITEMS.register("dark_boots",
            () -> new DarkArmor(ArmorInit.DARK, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> ZORA_ARMOR_CAP = ITEMS.register("zora_armor_cap",
            () -> new ZoraArmorArmor(ArmorInit.ZORAARMOR, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ZORA_ARMOR_TUNIC = ITEMS.register("zora_armor_tunic",
            () -> new ZoraArmorArmor(ArmorInit.ZORAARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ZORA_ARMOR_LEGGINGS = ITEMS.register("zora_armor_leggings",
            () -> new ZoraArmorArmor(ArmorInit.ZORAARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ZORA_ARMOR_BOOTS = ITEMS.register("zora_armor_flippers",
            () -> new ZoraArmorArmor(ArmorInit.ZORAARMOR, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> FLAMEBREAKER_HELMET = ITEMS.register("flamebreaker_helmet",
            () -> new FlamebreakerArmor(ArmorInit.FLAMEBREAKER, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> FLAMEBREAKER_TUNIC = ITEMS.register("flamebreaker_tunic",
            () -> new FlamebreakerArmor(ArmorInit.FLAMEBREAKER, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> FLAMEBREAKER_LEGGINGS = ITEMS.register("flamebreaker_leggings",
            () -> new FlamebreakerArmor(ArmorInit.FLAMEBREAKER, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> FLAMEBREAKER_BOOTS = ITEMS.register("flamebreaker_boots",
            () -> new FlamebreakerArmor(ArmorInit.FLAMEBREAKER, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> ANCIENT_HELMET = ITEMS.register("ancient_helmet",
            () -> new AncientArmor(ArmorInit.ANCIENT, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ANCIENT_CUIRASS = ITEMS.register("ancient_cuirass",
            () -> new AncientArmor(ArmorInit.ANCIENT, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ANCIENT_GREAVES = ITEMS.register("ancient_greaves",
            () -> new AncientArmor(ArmorInit.ANCIENT, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> ANCIENT_BOOTS = ITEMS.register("ancient_boots",
            () -> new AncientArmor(ArmorInit.ANCIENT, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> BARBARIAN_HELMET = ITEMS.register("barbarian_helmet",
            () -> new BarbarianArmor(ArmorInit.BARBARIAN, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BARBARIAN_ARMOR = ITEMS.register("barbarian_armor",
            () -> new BarbarianArmor(ArmorInit.BARBARIAN, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BARBARIAN_LEG_WRAPS = ITEMS.register("barbarian_leg_wraps",
            () -> new BarbarianArmor(ArmorInit.BARBARIAN, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> BARBARIAN_BOOTS = ITEMS.register("barbarian_boots",
            () -> new BarbarianArmor(ArmorInit.BARBARIAN, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> CLIMBERS_BANDANNA = ITEMS.register("climbers_bandanna",
            () -> new ClimbingGearArmor(ArmorInit.CLIMBING, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> CLIMBING_GEAR = ITEMS.register("climbing_gear",
            () -> new ClimbingGearArmor(ArmorInit.CLIMBING, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> CLIMBING_PANTS = ITEMS.register("climbing_pants",
            () -> new ClimbingGearArmor(ArmorInit.CLIMBING, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> CLIMBING_BOOTS = ITEMS.register("climbing_boots",
            () -> new ClimbingGearArmor(ArmorInit.CLIMBING, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> DESERT_VOE_HEADBAND = ITEMS.register("desert_voe_headband",
            () -> new DesertVoeHelmetItem(ArmorInit.DESERTVOE, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DESERT_VOE_SPAULDER = ITEMS.register("desert_voe_spaulder",
            () -> new DesertVoeArmorItem(ArmorInit.DESERTVOE, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DESERT_VOE_TROUSERS = ITEMS.register("desert_voe_trousers",
            () -> new DesertVoeLeggingsItem(ArmorInit.DESERTVOE, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> DESERT_VOE_BOOTS = ITEMS.register("desert_voe_boots",
            () -> new DesertVoeArmorItem(ArmorInit.DESERTVOE, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> SNOWQUILL_HEADDRESS = ITEMS.register("snowquill_headdress",
            () -> new SnowquillArmor(ArmorInit.SNOWQUILL, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> SNOWQUILL_TUNIC = ITEMS.register("snowquill_tunic",
            () -> new SnowquillArmor(ArmorInit.SNOWQUILL, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> SNOWQUILL_TROUSERS = ITEMS.register("snowquill_trousers",
            () -> new SnowquillArmor(ArmorInit.SNOWQUILL, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> SNOWQUILL_BOOTS = ITEMS.register("snowquill_boots",
            () -> new SnowquillArmor(ArmorInit.SNOWQUILL, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> SWIMMERS_RING = ITEMS.register("swimmers_ring",
            () -> new SwimmersRing(new Item.Properties().stacksTo(1)));
...
//            () -> new BlockItem(BlockInit.FARORES_FLAME.get(), new Item.Properties()));
    public static final RegistryObject<Item> BLOCK_OF_TIME = ITEMS.register("block_of_time",
            () -> new BlockOfTimeItem(BlockInit.BLOCK_OF_TIME.get()));
...
public static final RegistryObject<Item> FAN = ITEMS.register("fan", () -> new BlockItem(BlockInit.FAN.get(), new Item.Properties().stacksTo(64)));
public static final RegistryObject<Item> SWITCHABLE_FAN = ITEMS.register("switchable_fan", () -> new BlockItem(BlockInit.SWITCHABLE_FAN.get(), new Item.Properties().stacksTo(64)));
...
//            () -> new BlockItem(BlockInit.GRAPPLE_BLOCK.get(), new Item.Properties()));;
    public static final RegistryObject<Item> GRATE_BLOCK = ITEMS.register("grate_block",
            () -> new GrateItem(BlockInit.GRATE_BLOCK.get()));

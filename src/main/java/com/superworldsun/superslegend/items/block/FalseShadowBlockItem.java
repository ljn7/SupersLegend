...
public class FalseShadowBlockItem extends ShadowBlockBaseItem {
    public FalseShadowBlockItem() {
        super(BlockInit.FALSE_SHADOW_BLOCK.get(), new Item.Properties().stacksTo(64));
    }

    @OnlyIn(Dist.CLIENT)
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        tooltipComponents.add(Component.literal("This Block will fool the unobservant").withStyle(ChatFormatting.LIGHT_PURPLE));

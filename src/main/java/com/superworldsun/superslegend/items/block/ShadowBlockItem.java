...
public class ShadowBlockItem extends ShadowBlockBaseItem {
    public ShadowBlockItem() {
        super(BlockInit.SHADOW_BLOCK.get(), new Item.Properties().stacksTo(64));
    }

    public ShadowBlockItem(Block block, Properties properties) {
        super(block, properties);
    }
    @OnlyIn(Dist.CLIENT)
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        tooltipComponents.add(Component.literal("This Block copies the looks of others").withStyle(ChatFormatting.LIGHT_PURPLE));
